...
$template_type='';
$page_title = 'Roster'.CONST_TITLE_AFX;
$page_description = 'Add Roster';
$body_template_file = CONST_THEMES_TEMPLATE_INCLUDE_PATH . 'roster.tpl';
							...
							if($_cu_role==='REGULAR' && $loggedindata[0]['profile_details']['id'] === $recorddetails[0]['id']){
								...
								if(!empty($recp_users)){
									...
									$email_data = [
										...
										'gender' => $data['gender'],
										'profile_url' => CONST_APP_ABSURL.'/roster.php#mode=view&recid='.$recordid,
										'from_name' => CONST_MAIL_SENDERS_NAME,
									];
			...
			if($recorddetails===false){
				...
				if($recorddetails['dnd']=='y'){
					...
					$email_data = [
						...
						'msg' => trim($_POST['msg']),
						'org_name' => CONST_ORG_DISP_NAME,
						'link_to_profile' => CONST_APP_ABSURL.'/roster.php#mode=view&recid='.$loggedindata[0]['profile_details']['id'], // sender's profile
						'from_name' => CONST_MAIL_SENDERS_NAME,
